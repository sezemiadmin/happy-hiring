...
* **Q. では、技術探究心がある候補者に入社してもらったとして、ゴールまでどんなロードマップを考えられますかね? 例えば、Laravelチュートリアルからはじめて、とか**
    * **開発** その辺は候補者のスキルレベルに寄りますね
    * **Q.** その技術探究心があるという想定の中で、一番下の低いレベルから考えると、どうなります?
    * **開発** となると、まずLaravelの開発環境を作るところから入って、Larabel のチュートリアルをやって、というところからスタートですね
    * **Q.** では、その次は?
